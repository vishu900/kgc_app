...
import 'package:dataproject2/newmodel/SearchResultModel.dart';
...
import 'package:dataproject2/saleEnquiry/AddEditSaleEnquiry.dart';
...
class SaleEnquiry extends StatefulWidget {
  @override
  _SaleEnquiryState createState() => _SaleEnquiryState();
}

class _SaleEnquiryState extends State<SaleEnquiry> {
  /// Controllers
            ...
            child: FloatingActionButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => AddEditSaleEnquiry()));
                },
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    isDense: true,
                    hintText: 'Financial Year e.g. 20212022',
              ...
              /// Company Name
              TextFormField(
                  validator: (value) => companyCode!.isEmpty
  ...
  _search() async {
    ...
    WebService().post(this.context, AppConfig.searchEnquiry, json).then(
    ...
    if (value.statusCode == 200) {
      ...
      if (data['error'] == 'false') {
        ...
        if (searchResultList.isNotEmpty) {
          ...
          Commons().showAlert(context, 'No enquiry found', 'Result');
        }
      }
    }
  }
  ...
  _viewQuotation(int index) {
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                AddEditSaleEnquiry(qtnId: searchResultList[index].id)));
  }
