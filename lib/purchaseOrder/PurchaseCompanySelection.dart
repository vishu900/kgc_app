...
class PurchaseCompanySelection extends StatefulWidget {
  final CompanyList;

  final userId, name;

  const PurchaseCompanySelection(
      {Key? key, this.CompanyList, this.userId, this.name})
      : super(key: key);

  @override
  _PurchaseCompanySelectionState createState() =>
      _PurchaseCompanySelectionState();
}

class _PurchaseCompanySelectionState extends State<PurchaseCompanySelection> {
  // get http => null;
  ...
  bool? isLoading;
  String companyApiURl = "${AppConfig.baseUrl}api/purchase_company";
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        "(${firstdata[index]['count'].toString()})")
                                  ],
                                ),
                              ),
                            ),
