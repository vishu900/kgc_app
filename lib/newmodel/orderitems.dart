class OrderItems {
  ...
  OrderItems({String? compCode, String? compName, String? orderNo, String? order_date,String? party_name, String? approval_uid,  String? cont_person, String? approval_user_name, String? sod_pk,
  ...
  OrderItems.fromJson(Map<String, dynamic> json) {
    ...
    sod_pk = json['sod_pk'];
    catalog_item = json['catalog_item']!=null?json['catalog_item']['code']:'';
