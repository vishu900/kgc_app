...
import 'salary_advance_paid.dart';

class EmpAdvanceCompSelection extends StatefulWidget {
  @override
  _EmpAdvanceCompSelectionState createState() =>
      _EmpAdvanceCompSelectionState();
}

class _EmpAdvanceCompSelectionState extends State<EmpAdvanceCompSelection>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: [
            Flexible(child: Text('Employee Advance')),
          ],
        ),
        centerTitle: false,
      ),
          ...
          child: InkWell(
            ...
            onTap: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) =>
                      SalaryAdvancePaid(compId: companyList[index].id)));
            },
            child: Padding(
  ...
  _getCompanyList() {
    Map jsonBody = {
      'user_id': getUserId(),
      'tid': Permissions.SALARY_ADVANCE_PAID,
      'mode_flag': 'A,I'
    };
