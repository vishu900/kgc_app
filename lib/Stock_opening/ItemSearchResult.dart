...
import 'package:dataproject2/Stock_opening/stock_opening.dart';
...
class _ItemSearchResult extends State<ItemSearchResult> {
  ...
  Future<void> getCompanyList() async {
    final url = Uri.parse(
        "http://103.204.185.17:24977/webapi/api/Common/GetCompanyFromTask?p_Taskid=MATERIAL_ISSUE_4_PROD_ORD&p_userid=APPDBA");
