import 'package:dataproject2/Stock_opening/photoview_page_so.dart';
...
class ShowimageSO extends StatefulWidget {
  var itemCode;

  ShowimageSO({Key? key, required this.itemCode});

  @override
  State<ShowimageSO> createState() => _ShowimageSOState();
}

class _ShowimageSOState extends State<ShowimageSO> {
