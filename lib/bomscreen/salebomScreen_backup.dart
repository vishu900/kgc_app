...
/// This is a backup code file do not alter this in any manner.
/// By Abhimanyu on 02,Jul,2021
                  ...
                  case ConnectionState.done:
                    if (snapshot.hasError) {
                      ...
                      return listorders == null
                          ? Center(
                              child: Text("No Orders to Approve!"),
                            )
                          : PageView.builder(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            onTap: () {
                                                              ...
                                                              /*list[index]["catalog_item"]['image_count'] ==
                                                                      0
                                                                  ? Commons
                                                                      .showToast(
                                                                          'No images found.')
                                                                  : Navigator.push(
                                                                      ...
                                                                      MaterialPageRoute(
                                                                          builder: (context) => ImageViewer(
                                                                                itemCode: list[index]["catalog_item"]['code'],
                                                                              )));*/
                                                            },
                                                            child: Container(
                                                                width: 170,
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (response.statusCode ==
                                                                            ...
                                                                            if (errorcheck ==
                                                                              ...
                                                                              /// Count
                                                                              debugPrint('NotificationCount before ${AppConfig.prefs.getInt('fcmCount')}');

                                                                              if (AppConfig.prefs.getInt('fcmCount')! > 0) {
                                                                                AppConfig.prefs.setInt('fcmCount', AppConfig.prefs.getInt('fcmCount')! - 1);
                                                                              }

                                                                              debugPrint('NotificationCount after ${AppConfig.prefs.getInt('fcmCount')}');
...
//                                                              getImage1();
                                                                                ...
                                                                                Map data = {
                                                                                  ...
                                                                                  "company_code": widget.companycode.toString()
                                                                                };
...
//                                                                  }
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        child: Center(
                                                                            child:
                                                                                Text("APPROVE", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontFamily: 'Roboto', fontSize: 20, letterSpacing: 2.17)))),
                                                              ),
                                                            )),
...
//                                                                avatarImageFile1 =null;
                                                                              ...
                                                                              onPressed: () async {
                                                                                ...
                                                                                if (response.statusCode == 200) {
                                                                                  ...
                                                                                  if (errorcheck == "false") {
                                                                                    ...
                                                                                    logIt('LengthReject- ${list.length}');
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        child: Center(
                                                                            child:
                                                                                Text("REJECT", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontFamily: 'Roboto', fontSize: 20, letterSpacing: 2.17)))),
                                                              ),
                                                            )),
                                                ],
                                              ),
