...
class ProcessOrder extends StatefulWidget {
  ProcessOrderModel processorderData;

  ProcessOrder({super.key, required this.processorderData});
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.processorderData.pro_odr_name.toString(),
                            ...
                            Row(
                              children: [
                                Expanded(
                                  flex: 1,
                                  child: Text(
                                    widget.processorderData.prdOrderNo
                                        .toString(),
                                    style: const TextStyle(
                                ...
                                Expanded(
                                  flex: 1,
                                  child: Text(
                                    widget.processorderData.catalogCode
                                        .toString(),
                                    style: const TextStyle(
                                      fontWeight: FontWeight.w600,
                                    ),
                                ...
                                Expanded(
                                  ...
                                  child: Text(
                                    DateFormat('dd.MM.yy').format(
                                      DateTime.parse(
                                          widget.processorderData.orderDate),
                                    ),
                                    style: const TextStyle(
                                      fontWeight: FontWeight.w600,
                                    ),
